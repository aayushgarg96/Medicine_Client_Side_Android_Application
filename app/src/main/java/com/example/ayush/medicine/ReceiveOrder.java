...
/**
 * Created by Ayush on 12/23/2016.
 */
public class ReceiveOrder extends AsyncTask<String, Void, String> {
    Context C;
    String fresult;

    public ReceiveOrder(Context C) {
        this.C = C;
    }
    ...
    protected String doInBackground(String... params) {
        String k = params[0];
        try {
            URL url = new URL("http://minorprojectf5.esy.es/receiveOrder.php");
    ...
    protected void onPostExecute(String s) {
        if(s.equals("YES")){
            Toast.makeText(C, "Thank you for choosing us.", Toast.LENGTH_SHORT).show();
        }
        else{
